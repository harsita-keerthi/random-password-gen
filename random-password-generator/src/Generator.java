...
public class Generator {
    ...
    private void printUsefulInfo() {
        ...
        System.out.println("Include lowercase and uppercase alphabetic characters as well as numbers and special characters");
        System.out.println("Use randomly generated passwords and avoid using personal information");
    ...
    private void requestPassword() {
        ...
        System.out.println();
        System.out.println("Hello, welcome to My Password Generator! answer"
    ...
    private void PasswordRequestError(String i) {
        if (!i.equalsIgnoreCase("yes") && !i.equalsIgnoreCase("no")) {
            System.out.println("You have entered something incorrect, let's go over the options again \n");
        }
    }
